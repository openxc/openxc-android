...
public class SimpleModemMessageAdapter extends KeyedMessageAdapter {
    private Context mContext;

    public SimpleModemMessageAdapter(Context context) {
        super();
        mContext = context;
    }

    @Override
    public SimpleModemMessage getItem(int position) {
        return mValues.get(position).asSimpleModemMessage();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SimpleModemMessage message = getItem(position);
    ...
    public boolean shouldRefreshView(KeyedMessage message, KeyedMessage existingMessage) {
        ...
        return (((SimpleModemMessage)message).getValue()).equals(
                ((SimpleModemMessage)existingMessage).getValue());
    }
}
