...
public class OpenXcEnablerActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabsAdapter.addTab(bar.newTab().setText("Command"),
                SendCommandMessageFragment.class,null);
    ...
    /**Existing Implementation replaced for the sake of dynamic GUI changes -tab swaps
     ...
     private static final String[] mTitles = { "Status", "Dashboard", "Modem Diag", "V2X Diag",
     ...
     Log.e(TAG, "Gets triggered now - getpagetitle!");
     ...
     Log.e(TAG, "It gets here during tab switch!");

     if(position == 1) {
     return new VehicleDashboardFragment();
     } else if(position == 2) {
     return new ModemDiagnosticsFragment();
     } else if(position == 3){
     V2XDiagnosticsFragment v2f= new V2XDiagnosticsFragment();
     v2f.setMenuVisibility(false);
     return v2f;
     } else if(position == 4) {
