...
public class Command extends KeyedMessage {
    ...
    public String toString() {
        return toStringHelper(this)
                ...
                .add(COMMAND_KEY, getCommand())
                .add(BUS_KEY, getBus())
                .add(ENABLED_KEY, isEnabled())
                .add(BYPASS_KEY, isBypass())
                .add(FORMAT_KEY, getFormat())
                .add(UNIX_TIME_KEY,getUnixTime())
                .add(ACTION_KEY, getAction())
