...
public class V2XCommand extends KeyedMessage {
	public static final String COMMAND_KEY = "V2X_command";
    ...
    public V2XCommand(CommandType command, String action) {
        mCommand = command;
        mAction = action;
    }

    public V2XCommand(CommandType command) {
        this(command, null);
    }

    public V2XCommand(DiagnosticRequest request, String action) {
    ...
    protected V2XCommand(Parcel in)
            throws UnrecognizedMessageTypeException {
        readFromParcel(in);
    }

    protected V2XCommand() { }
